...
export const cases: TestCase<Solution>[] = [
  ...
  {
    input: [arrayToLinkedList([9, 9, 9, 9, 9, 9, 9]), arrayToLinkedList([9, 9, 9, 9])],
 ...
 */
export const iterativeSolution = SolutionSchema.implement((l1: ListNode | null, l2: ListNode | null) => {
